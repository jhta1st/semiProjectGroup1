...
<body>
	<div style="border: 2px solid black; width: 800px;">
		<form method="post" action="${cp }/FreeBoard/write.do" enctype="multipart/form-data">
			<div><input type="text" size="100%" name="freeBoardTitle"></div>
			<div><textarea rows="30" cols="100%" draggable="false" name="freeBoardContent"></textarea></div>
			<div id="fileUploadPlusArea"></div>
			<div>
				<input type="button" value="파일첨부하기" onclick="fileUploadPlus();"><br>
				<input type="hidden" name="userId" value="${sessionScope.id }">
				<input type="submit" value="전송"><input type="button" value="취소" onclick="javascript:history.go(-1);">
			</div>
		</form>
