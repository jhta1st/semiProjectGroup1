...
<style>
	...
	#adminMoviePeoplePage #adminMoviePeoplePageForm .adminMoviePeopleUpdateBtn {
	     margin-right : 150px;
	}
	.adminMoviePeopleDeleteBtn {
	font-weight:bold;
...
.adminMoviePeopleDeleteBtn:active {
...
.adminMoviePeopleDeleteBtn:hover {
	background:#454545;
...
.adminMoviePeopleUpdateBtn:active {
	box-shadow:inset #595959 0px 5px 8px -1px,#a6a6a6 0px 0 6px;
	o-box-shadow:inset #595959 0px 5px 8px -1px,#a6a6a6 0px 0 6px;
	-moz-box-shadow:inset #595959 0px 5px 8px -1px,#a6a6a6 0px 0 6px;
	-webkit-box-shadow:inset #595959 0px 5px 8px -1px,#a6a6a6 0px 0 6px;
...
.adminMoviePeopleUpdateBtn:hover {
	background:#454545;
	background:-o-linear-gradient(90deg, #454545, #787878);
	background:-moz-linear-gradient( center top, #454545 5%, #787878 100% );
	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #454545), color-stop(1, #787878) );
...
<div id="adminMoviePeoplePage">
<div id="adminMoviePeoplePageForm">
<h1>인물상세</h1>
<hr>
<table border="1">
	<tr>
...
<br>
<hr>
<a class="adminMoviePeopleDeleteBtn" href="${pageContext.request.contextPath}/admin/MoviePeopleDelete.do?charNum=${vo.charNum}">삭제</a> |
<a class="adminMoviePeopleUpdateBtn" href="${pageContext.request.contextPath}/admin/MoviePeopleUpdate.do?charNum=${vo.charNum}">수정</a>
<hr>
<a class="adminMoviePeopleCBBtn" href="${pageContext.request.contextPath }/admin/index.do">관리자홈</a>
</div>
</div>
